...
public class ConeKatFemaleEntityModel extends AdvancedHumanoidModel<ConeKatFemaleEntity> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ChangedExtras.MODID, "conekat_female"), "main");
    ...
    private final HumanoidAnimator<ConeKatFemaleEntity, ConeKatFemaleEntityModel> animator;

    public ConeKatFemaleEntityModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 16).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(15, 33).addBox(-3.0F, -3.0F, -5.0F, 6.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(15, 33).addBox(2.0F, -2.0F, -3.0F, 5.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(15, 33).addBox(-7.0F, -2.0F, -3.0F, 5.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(15, 33).addBox(2.0F, -4.0F, -3.0F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(15, 33).addBox(-6.0F, -4.0F, -3.0F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.5F, 0.0F));
        ...
        Torso.addOrReplaceChild("Chest_r1", CubeListBuilder.create().texOffs(26, 29).addBox(-5.0F, -27.0F, -3.0F, 8.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 26.0F, 2.0F, 0.0873F, 0.0F, 0.0F));
        PartDefinition Tail = Torso.addOrReplaceChild("Tail", CubeListBuilder.create(), PartPose.offset(0.0F, 10.5F, 4.0F));
        PartDefinition TailPrimary = Tail.addOrReplaceChild("TailPrimary", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1309F, 0.0F, 0.0F));
        TailPrimary.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(48, 50).addBox(-2.0F, -3.25F, -1.5F, 4.0F, 9.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.1781F, 0.0F, 0.0F));
        PartDefinition TailSecondary = TailPrimary.addOrReplaceChild("TailSecondary", CubeListBuilder.create(), PartPose.offset(0.0F, 1.25F, 4.5F));
        TailSecondary.addOrReplaceChild("Base_r2", CubeListBuilder.create().texOffs(75, -1).addBox(-2.5F, -4.45F, -2.1F, 5.0F, 11.0F, 6.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.5F, 1.0F, 1.4835F, 0.0F, 0.0F));
        ...
        TailTertiary.addOrReplaceChild("Base_r3", CubeListBuilder.create().texOffs(27, 55).addBox(-2.0F, -5.2F, -1.95F, 4.0F, 10.0F, 5.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, -1.0F, 7.0F, 1.8326F, 0.0F, 0.0F));
    ...
    @Override
    public void prepareMobModel(ConeKatFemaleEntity entity, float limbSwing, float limbSwingAmount, float partialTicks) {
        super.prepareMobModel(entity, limbSwing, limbSwingAmount, partialTicks);
    }

    @Override
    public void setupHand(ConeKatFemaleEntity entity) {
        animator.setupHand();
    }

    @Override
    public void setupAnim(@NotNull ConeKatFemaleEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<ConeKatFemaleEntity, ?> getAnimator(ConeKatFemaleEntity entity) {
        return animator;
    }
}
