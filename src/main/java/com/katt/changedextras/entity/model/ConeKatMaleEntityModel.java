...
public class ConeKatMaleEntityModel extends AdvancedHumanoidModel<ConeKatMaleEntity> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ChangedExtras.MODID, "conekat_male"), "main");
    ...
    private final HumanoidAnimator<ConeKatMaleEntity, ConeKatMaleEntityModel> animator;

    public ConeKatMaleEntityModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void prepareMobModel(ConeKatMaleEntity entity, float limbSwing, float limbSwingAmount, float partialTicks) {
        super.prepareMobModel(entity, limbSwing, limbSwingAmount, partialTicks);
    }

    @Override
    public void setupHand(ConeKatMaleEntity entity) {
        animator.setupHand();
    }

    @Override
    public void setupAnim(@NotNull ConeKatMaleEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<ConeKatMaleEntity, ?> getAnimator(ConeKatMaleEntity entity) {
        return animator;
    }
}
