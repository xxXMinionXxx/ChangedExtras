...
public abstract class AbstractConeKatEntity extends ChangedEntity implements GenderedEntity {

    private final LatexCreatureInventory inventory = new LatexCreatureInventory(this);

    protected AbstractConeKatEntity(EntityType<? extends ChangedEntity> type, Level level) {
        super(type, level);
    }
