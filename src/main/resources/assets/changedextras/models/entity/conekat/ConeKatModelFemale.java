public class ConeKatFemaleEntityModel extends AdvancedHumanoidModel<TestEntity> implements AdvancedHumanoidModelInterface<TestEntity, TestEntityModel> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Chest_r1 = Torso.addOrReplaceChild("Chest_r1", CubeListBuilder.create().texOffs(26, 29).addBox(-5.0F, -27.0F, -3.0F, 8.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 26.0F, 2.0F, 0.0873F, 0.0F, 0.0F));
		...
		PartDefinition Base_r1 = TailPrimary.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(48, 50).addBox(-2.0F, -3.25F, -1.5F, 4.0F, 9.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.1781F, 0.0F, 0.0F));

		PartDefinition TailSecondary = TailPrimary.addOrReplaceChild("TailSecondary", CubeListBuilder.create(), PartPose.offset(0.0F, 1.25F, 4.5F));

		PartDefinition Base_r2 = TailSecondary.addOrReplaceChild("Base_r2", CubeListBuilder.create().texOffs(75, -1).addBox(-2.5F, -4.45F, -2.1F, 5.0F, 11.0F, 6.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0F, 0.5F, 1.0F, 1.4835F, 0.0F, 0.0F));
		...
		PartDefinition Base_r3 = TailTertiary.addOrReplaceChild("Base_r3", CubeListBuilder.create().texOffs(27, 55).addBox(-2.0F, -5.2F, -1.95F, 4.0F, 10.0F, 5.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(0.0F, -1.0F, 7.0F, 1.8326F, 0.0F, 0.0F));
