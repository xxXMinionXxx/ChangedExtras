...
public class Katt<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition OuterHairLayer_r1 = Hair.addOrReplaceChild("OuterHairLayer_r1", CubeListBuilder.create().texOffs(78, 32).addBox(-4.0F, -8.0F, -6.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.3F)), PartPose.offsetAndRotation(0.0F, -1.0F, 2.0F, 0.2618F, 0.0F, 0.0F));

		PartDefinition InnerHairLayer_r1 = Hair.addOrReplaceChild("InnerHairLayer_r1", CubeListBuilder.create().texOffs(77, 37).addBox(-2.0F, -9.0F, -7.0F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.0F, 0.1309F, 0.0F));
